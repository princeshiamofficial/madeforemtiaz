...
let settings = {
    ...
    countdown: 3,
    matrixText: 'HBD|EMTIAZ|DESIGNER',
    matrixColor1: '#87ceeb', // Blue theme
    matrixColor2: '#4169e1', // Blue theme
    sequence: 'HAPPY|BIRTHDAY|EMTIAZ|BHAI|THE|WORLD\'S|BEST|GRAPHIC|DESIGNER|🎨|✨|❤',
    sequenceColor: '#1e90ff', // Blue theme
    ...
    pages: [
        ...
        { 
            image: './image/photos/b1.jpg', 
        },

        // --- Lembar 2 (data-page="1") ---
        { 
            image: './image/photos/b2.jpg', 
            content: 'Happy Birthday to the most creative person I know! 🎨' 
        },
        { 
            image: './image/photos/b3.jpg', 
        },

        // --- Lembar 3 (data-page="2") ---
        { 
            image: './image/theend.jpg', 
            content: 'Keep designing magic, Emtiaz Bhai. Have a legendary year ahead! 🚀' 
        }
    ],
    enableBook: true,
    enableHeart: true,
